...
import { InventoryItem, Transaction, PaymentMethod, StaffUser } from '../../types/pos';
...
export const RefundModal: React.FC<RefundModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#0F1115]/85 flex items-center justify-center p-3 sm:p-6 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 my-4 overflow-y-auto flex-1 pr-1">
          ...
          <div className="lg:col-span-5 bg-[#0F1115] p-4 rounded-xl border border-[#1E293B] flex flex-col justify-between space-y-3">
            ...
            <div className="space-y-3">
              ...
              {/* Cashier Session Lock Info / Admin Override */}
              {isAdmin ? (
                <div className="bg-[#161B22] border border-amber-500/40 rounded-xl p-2.5 space-y-1 text-xs">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-bold text-amber-400 uppercase tracking-wider flex items-center gap-1">
                      <ShieldCheck className="w-3.5 h-3.5" />
                      Admin Refund Authorizer Override
                    </span>
                  ...
                  <select
                    ...
                    className="w-full bg-[#0F1115] border border-[#1E293B] rounded-lg px-2.5 py-1 text-xs text-white focus:outline-none focus:border-amber-500 font-medium"
                  >
                ...
                <div className="bg-[#161B22] border border-rose-500/30 rounded-xl p-2.5 flex items-center justify-between text-xs">
                  <div className="flex items-center gap-2">
                    <Lock className="w-3.5 h-3.5 text-rose-400 shrink-0" />
                    <span className="text-slate-300">
                      Processing Cashier Account:{' '}
                      <strong className="text-white font-semibold">{cashierName}</strong>
                    </span>
                  </div>
                  <span className="text-[10px] font-mono bg-rose-500/10 text-rose-300 border border-rose-500/20 px-1.5 py-0.2 rounded font-bold">
                    SESSION LOCKED
                  </span>
                </div>
              )}
